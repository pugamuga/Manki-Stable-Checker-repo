  ...
  return (
    <div className=" border-2 h-full rounded-lg border-slate-400 relative">
      <div className="flex justify-center mt-[10%] ">
        <button
          onClick={generateFn}
          className=" shadow-lg inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium  rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white text-white focus:ring-4 focus:outline-none focus:ring-blue-800"
        >
          <span className=" px-5 py-2.5 transition-all ease-in duration-75  bg-slate-500 rounded-md group-hover:bg-opacity-0">
            Generate
          </span>
        </button>
      </div>
